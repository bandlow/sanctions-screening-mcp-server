...
export const SOURCE_LICENSES: Record<SourceCode, string> = {
  ...
  us_bis_entity: 'US Government public domain',
  us_bis_dpl: 'US Government public domain',
  us_bis_unverified: 'US Government public domain',
};
...
export function sourceUrls(): Record<SourceCode, string> {
  ...
  return {
    ...
    un: cfg.unScUrl,
    us_bis_entity: cfg.bisEntityUrl,
    us_bis_dpl: cfg.bisDplUrl,
    us_bis_unverified: cfg.bisUnverifiedUrl,
  };
}
