...
export const getEntityTool = tool("sanctions_get_entity", {
  ...
  output: z.object({
    ...
    otherNames: z
      .array(z.string())
      .describe("Other / trading names published in the LEI record."),
    jurisdiction: z
      .string()
      .optional()
    ...
    status: z
      .string()
      .optional()
      .describe("Registration status (e.g. ISSUED, LAPSED)."),
    legalAddress: z
      .string()
      .optional()
      .describe("Single-line legal address, when published."),
    ...
    registrationAuthorityEntityId: z
      ...
      .optional()
      .describe(
        "The entity's ID at its registration authority, when published.",
      ),
    lastUpdate: z
      .string()
      .optional()
    ...
    sanctionsHits: z
      ...
      .describe(
        "Sanctions screening cross-reference on the entity's legal name.",
      ),
    sanctionsScreen: z
      .object({
        totalAvailable: z
  ...
  errors: [
    ...
    },
    {
      ...
      retryable: true,
      recovery:
        "Run the mirror:init lifecycle script to load the GLEIF golden copy, then retry.",
    },
  ],
  ...
  async handler(input, ctx) {
    ...
    const screeningStatus: "screened" | "not_ready" = sanctionsReady
      ? "screened"
      : "not_ready";
