...
const ServerConfigSchema = z.object({
  mirrorPath: z
    ...
    .describe(
      "Filesystem path for the SQLite mirror; a persistent volume on a hosted deployment.",
    ),
  refreshCron: z
    .string()
    .default("0 4 * * *")
  ...
  euFsfUrl: z
    ...
    .describe(
      "EU consolidated XML URL (includes the static public token path component).",
    ),
  ukSanctionsUrl: z
    .string()
  ...
  bisEntityUrl: z
    ...
    .describe(
      "Optional US BIS Entity List CSV URL. Leave empty to disable this source.",
    ),
  bisDplUrl: z
    .string()
  ...
  bisUnverifiedUrl: z
    ...
    .describe(
      "Optional US BIS Unverified List CSV URL. Leave empty to disable this source.",
    ),
