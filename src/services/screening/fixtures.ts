...
export const FIXTURE_DESIGNATIONS: NormalizedDesignation[] = [
  ...
  },
  {
    ...
    payload: {
      ...
      nationalities: ["Testland"],
      remarks:
        "Synthetic transliteration-class test entry — not a real person.",
    },
  },
  {
    id: "un:FX-5005",
  ...
  },
  {
    ...
    payload: {
      ...
      nationalities: [],
      remarks:
        "Synthetic single-token false-positive test entry — not a real person.",
    },
  },
  {
    ...
    payload: {
      ...
      nationalities: [],
      remarks:
        "Synthetic whole-string prefix-inflation test entry — not a real person.",
    },
  },
  {
    ...
    payload: {
      ...
      nationalities: [],
      remarks:
        "Synthetic spacing/concatenation recall test entry — not a real organization.",
    },
  },
  {
    // Multiple hits test case: "Diamond" appears in multiple designations as either
    // primary name or aliases to test fuzzy matching with multiple results and
    // varying match types (exact, strong, approximate).
    id: "ofac_sdn:FX-1011",
    source: "ofac_sdn",
    sourceEntryId: "FX-1011",
    entityType: "organization",
    primaryName: "Diamond Trading Syndicate",
    program: "TEST-PROGRAM",
    designationDate: "2023-03-15",
    payload: {
      aliases: [
        { name: "Diamond Traders", nameType: "aka" },
        { name: "DTS Corporation", nameType: "aka" },
      ],
      identifiers: [],
      addresses: [{ full: "Diamond District, New York", country: "USA" }],
      datesOfBirth: [],
      nationalities: [],
      remarks: "Synthetic test designation for multiple hit scenarios.",
    },
  },
  {
    // Second Diamond entry to verify multiple matches
    id: "eu:FX-1012",
    source: "eu",
    sourceEntryId: "FX-1012",
    entityType: "organization",
    primaryName: "Black Diamond Holdings",
    program: "EU-TEST-REGIME",
    designationDate: "2022-05-20",
    payload: {
      aliases: [
        { name: "Diamond Holdings", nameType: "aka" },
        { name: "BDH Ltd", nameType: "aka" },
      ],
      identifiers: [],
      addresses: [{ full: "Amsterdam, Netherlands", country: "NL" }],
      datesOfBirth: [],
      nationalities: [],
      remarks: "Synthetic test designation with Diamond variant.",
    },
  },
  {
    // Third Diamond entry for fuzzy matching test
    id: "uk:FX-1013",
    source: "uk",
    sourceEntryId: "FX-1013",
    entityType: "organization",
    primaryName: "Diamond Mines and Resources Ltd",
    program: "UK-TEST-SANCTIONS",
    designationDate: "2023-09-10",
    payload: {
      aliases: [
        { name: "DMR Ltd", nameType: "aka" },
        { name: "Diamond Mining Services", nameType: "aka" },
      ],
      identifiers: [],
      addresses: [{ full: "London, United Kingdom", country: "GB" }],
      datesOfBirth: [],
      nationalities: [],
      remarks: "Synthetic test designation for Diamond matching verification.",
    },
  },
];
